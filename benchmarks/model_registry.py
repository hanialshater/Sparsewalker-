...
LEARNED=["GRU4Rec","SASRec","SASRec+SS","LiGR+FullCE","eSASRec","BERT4Rec","FMLP-Rec","Mamba4Rec","SparseWalker","SparseWalker-E2E"]
...
def build_model(name,n_items,max_len,d=64,layers=2,heads=2,inner=256,dropout=.2):
    ...
    if name in ("LiGR+FullCE","eSASRec"): return ESASRec(n_items,max_len,d,layers,heads,inner,dropout)
